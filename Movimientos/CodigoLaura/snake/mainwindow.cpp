...
int MainWindow::q1()   {if(ui->q1->checkState()==Qt::Checked)      return MOD_ACTIVOS[0]=1;     else  return MOD_ACTIVOS[0]=0;}
int MainWindow::q2()   {if(ui->q2->checkState()==Qt::Checked)      return MOD_ACTIVOS[1]=1;     else  return MOD_ACTIVOS[1]=0;}
int MainWindow::q3()   {if(ui->q3->checkState()==Qt::Checked)      return MOD_ACTIVOS[2]=1;     else  return MOD_ACTIVOS[2]=0;}
int MainWindow::q4()   {if(ui->q4->checkState()==Qt::Checked)      return MOD_ACTIVOS[3]=1;     else  return MOD_ACTIVOS[3]=0;}
int MainWindow::q5()   {if(ui->q5->checkState()==Qt::Checked)      return MOD_ACTIVOS[4]=1;     else  return MOD_ACTIVOS[4]=0;}
int MainWindow::q6()   {if(ui->q6->checkState()==Qt::Checked)      return MOD_ACTIVOS[5]=1;     else  return MOD_ACTIVOS[5]=0;}
int MainWindow::q7()   {if(ui->q7->checkState()==Qt::Checked)      return MOD_ACTIVOS[6]=1;     else  return MOD_ACTIVOS[6]=0;}
int MainWindow::q8()   {if(ui->q8->checkState()==Qt::Checked)      return MOD_ACTIVOS[7]=1;     else  return MOD_ACTIVOS[7]=0;}
int MainWindow::q9()   {if(ui->q9->checkState()==Qt::Checked)      return MOD_ACTIVOS[8]=1;     else  return MOD_ACTIVOS[8]=0;}
int MainWindow::q10()  {if(ui->q10->checkState()==Qt::Checked)     return MOD_ACTIVOS[9]=1;     else  return MOD_ACTIVOS[9]=0;}
int MainWindow::q11()  {if(ui->q11->checkState()==Qt::Checked)     return MOD_ACTIVOS[10]=1;    else  return MOD_ACTIVOS[10]=0;}
int MainWindow::q12()  {if(ui->q12->checkState()==Qt::Checked)     return MOD_ACTIVOS[11]=1;    else  return MOD_ACTIVOS[11]=0;}
int MainWindow::q13()  {if(ui->q13->checkState()==Qt::Checked)     return MOD_ACTIVOS[12]=1;    else  return MOD_ACTIVOS[12]=0;}
int MainWindow::q14()  {if(ui->q14->checkState()==Qt::Checked)     return MOD_ACTIVOS[13]=1;    else  return MOD_ACTIVOS[13]=0;}
int MainWindow::q15()  {if(ui->q15->checkState()==Qt::Checked)     return MOD_ACTIVOS[14]=1;    else  return MOD_ACTIVOS[14]=0;}
int MainWindow::q16()  {if(ui->q16->checkState()==Qt::Checked)     return MOD_ACTIVOS[15]=1;    else  return MOD_ACTIVOS[15]=0;}
int MainWindow::torque()   {if(ui->torque->checkState()==Qt::Checked)      return torque_e=1;     else  return torque_e=0;}
int MainWindow::velocidad()   {if(ui->velocidad->checkState()==Qt::Checked)      return velocidad_d=1;     else  return velocidad_d=0;}
...
void MainWindow::set_amplitud_par(int val)      {MainWindow::amplitud_par=val;  }
void MainWindow::set_amplitud_impar(int val)    {MainWindow::amplitud_impar=val;}
void MainWindow::set_offset_par(int val)        {MainWindow::offset_par=val;    }
void MainWindow::set_offset_impar(int val)      {MainWindow::offset_impar=val;  }
void MainWindow::set_dtheta_dn(int val)         {MainWindow::dtheta_dn=val;     }
void MainWindow::set_dtheta_dt(int val)         {MainWindow::dtheta_dt=val;     }
void MainWindow::set_desfase(int val)           {MainWindow::desfase=val;       }
void MainWindow::set_tiempo(int val)            {MainWindow::tiempo=val;        }

int MainWindow::get_amplitud_par()              {return MainWindow::amplitud_par;   }
int MainWindow::get_amplitud_impar()            {return MainWindow::amplitud_impar; }
int MainWindow::get_offset_par()                {return MainWindow::offset_par;     }
int MainWindow::get_offset_impar()              {return MainWindow::offset_impar;   }
int MainWindow::get_dtheta_dn()                 {return MainWindow::dtheta_dn;      }
int MainWindow::get_dtheta_dt()                 {return MainWindow::dtheta_dt;      }
int MainWindow::get_desfase()                   {return MainWindow::desfase;        }
int MainWindow::get_tiempo()                    {return MainWindow::tiempo;         }
...
void MainWindow::mover(){
   //variables locales
    ...
    MainWindow::set_amplitud_par(amplitud_par); MainWindow::set_amplitud_impar(amplitud_impar);
    MainWindow::set_offset_par(offset_par);     MainWindow::set_offset_impar(offset_impar);
    MainWindow::set_dtheta_dn(dtheta_dn);       MainWindow::set_dtheta_dt(dtheta_dt);
    MainWindow::set_desfase(desfase);           MainWindow::set_tiempo(tiempo);
    MainWindow::q1();    MainWindow::q2();      MainWindow::q3();    MainWindow::q4();    MainWindow::q5();    MainWindow::q6();
    MainWindow::q7();    MainWindow::q8();      MainWindow::q9();    MainWindow::q10();   MainWindow::q11();   MainWindow::q12();
    MainWindow::q13();   MainWindow::q14();     MainWindow::q15();   MainWindow::q16();   MainWindow::torque();MainWindow::velocidad();
...
void MainWindow::sidewinding_low(){
    ui->tiempo->setValue(4);    ui->amplitud_par->setValue(40);   ui->amplitud_impar->setValue(10);ui->offset_par->setValue(0);
